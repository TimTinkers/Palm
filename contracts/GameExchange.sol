...
contract GameExchange is DetailedERC721, ERC721Token {
  ...
  // Token name
  string private _name = "GameExchange";

  // Token symbol
  string private _symbol = "GEX";
  ...
  function GameExchange(address _authority) public {
  ...
  */
  ...
  function getOptIn(uint256 _tokenId) public returns (bool) {
